...
// TEST_CASE("fails when x value undefined while parsing unevenly spaced xy
// data",
//    "[XyPoints]")
//{
//    std::string input{"##XYPOINTS= (XY..XY)\r\n"
...
// TEST_CASE(
//    "fails when NPOINTS does not match number of xy data points",
//    "[XyPoints]")
//{
//    std::string input{"##XYPOINTS= (XY..XY)\r\n"
//                      "450.0, 10.0; 451.0, 11.0\r\n"
...
//            && Catch::Matchers::Contains("mismatch",
