...
TEST_CASE("throws exception when reading past end and constructed from file", "[binary_reader]") {
    auto path = "resources/test.bin";
    sciformats::common::binary_reader reader(path);
...
TEST_CASE("correctly reads istream", "[binary_reader]") {
    ...
    sciformats::common::binary_reader reader(ss, sciformats::common::binary_reader::big_endian);
...
TEST_CASE("throws exception when reading past end and constructed from char vector", "[binary_reader]") {
    std::vector<char> bytes { 0x00_c, 0xFF_c, 0x7F_c };
    sciformats::common::binary_reader reader(bytes);
...
TEST_CASE("throws exception when reading past end and constructed from uint8_t vector", "[binary_reader]") {
    std::vector<uint8_t> bytes { 0x00, 0xFF, 0x7F };
    sciformats::common::binary_reader reader(bytes);
...
TEST_CASE("read int16 correctly", "[binary_reader]") {
    ...
    sciformats::common::binary_reader reader_le(bytes, sciformats::common::binary_reader::little_endian);

    REQUIRE(reader_le.read_int16() == expected);
    reader_le.seekg(0, std::ios::beg);
    REQUIRE(reader_le.read_int16(sciformats::common::binary_reader::little_endian) == expected);

    // big endian
    std::reverse(bytes.begin(), bytes.end());
    sciformats::common::binary_reader reader_be(bytes, sciformats::common::binary_reader::big_endian);

    REQUIRE(reader_be.read_int16() == expected);
    reader_be.seekg(0, std::ios::beg);
    REQUIRE(reader_be.read_int16(sciformats::common::binary_reader::big_endian) == expected);
}
...
TEST_CASE("read uint16 correctly", "[binary_reader]") {
    ...
    reader_le.seekg(0, std::ios::beg);
    REQUIRE(reader_le.read_uint16(sciformats::common::binary_reader::little_endian) == expected);
    ...
    reader_be.seekg(0, std::ios::beg);
    REQUIRE(reader_be.read_uint16(sciformats::common::binary_reader::big_endian) == expected);
}
...
TEST_CASE("read int32 correctly", "[binary_reader]") {
    ...
    reader_le.seekg(0, std::ios::beg);
    REQUIRE(reader_le.read_int32(sciformats::common::binary_reader::little_endian) == expected);
    ...
    reader_be.seekg(0, std::ios::beg);
    REQUIRE(reader_be.read_int32(sciformats::common::binary_reader::big_endian) == expected);
}
...
TEST_CASE("read uint32 correctly", "[binary_reader]") {
    ...
    reader_le.seekg(0, std::ios::beg);
    REQUIRE(reader_le.read_uint32(sciformats::common::binary_reader::little_endian) == expected);
    ...
    reader_be.seekg(0, std::ios::beg);
    REQUIRE(reader_be.read_uint32(sciformats::common::binary_reader::big_endian) == expected);
}
...
TEST_CASE("read int64 correctly", "[binary_reader]") {
    ...
    reader_le.seekg(0, std::ios::beg);
    REQUIRE(reader_le.read_int64(sciformats::common::binary_reader::little_endian) == expected);
    ...
    reader_be.seekg(0, std::ios::beg);
    REQUIRE(reader_be.read_int64(sciformats::common::binary_reader::big_endian) == expected);
}
...
TEST_CASE("read uint64 correctly", "[binary_reader]") {
    ...
    reader_le.seekg(0, std::ios::beg);
    REQUIRE(reader_le.read_uint64(sciformats::common::binary_reader::little_endian) == expected);
    ...
    reader_be.seekg(0, std::ios::beg);
    REQUIRE(reader_be.read_uint64(sciformats::common::binary_reader::big_endian) == expected);
}
...
TEST_CASE("read float32 correctly", "[binary_reader]") {
    ...
    reader_le.seekg(0, std::ios::beg);
    REQUIRE(reader_le.read_float(sciformats::common::binary_reader::little_endian) == Approx(expected));
    ...
    reader_be.seekg(0, std::ios::beg);
    REQUIRE(reader_be.read_float(sciformats::common::binary_reader::big_endian) == Approx(expected));
}
...
TEST_CASE("read float64 correctly", "[binary_reader]") {
    ...
    reader_le.seekg(0, std::ios::beg);
    REQUIRE(reader_le.read_double(sciformats::common::binary_reader::little_endian) == Approx(expected));
    ...
    reader_be.seekg(0, std::ios::beg);
    REQUIRE(reader_be.read_double(sciformats::common::binary_reader::big_endian) == Approx(expected));
}
